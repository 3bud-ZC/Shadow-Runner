...
export const DIFFICULTY_STAGES: DifficultyStage[] = [
  { stage: 1, name: 'STAGE 1', minTimeMs: 0, maxShadows: 1 },
  { stage: 2, name: 'STAGE 2', minTimeMs: 15000, maxShadows: 2 },
  { stage: 3, name: 'STAGE 3', minTimeMs: 30000, maxShadows: 3 },
  { stage: 4, name: 'STAGE 4', minTimeMs: 50000, maxShadows: 4 },
  { stage: 5, name: 'STAGE 5', minTimeMs: 75000, maxShadows: 5 },
];
