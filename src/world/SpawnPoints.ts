...
export const ARENA_ORB_SPAWN_POINTS: readonly SpawnPoint[] = [
  ...
  { id: 6, x: 200, y: 490, name: 'Low Left Inner', riskTier: 'low' },
  { id: 7, x: 360, y: 490, name: 'Low Left Outer', riskTier: 'medium' },
  { id: 8, x: 920, y: 490, name: 'Low Right Inner', riskTier: 'medium' },
  { id: 9, x: 1080, y: 490, name: 'Low Right Outer', riskTier: 'low' },

  // Mid-tier center platform (y=410)
  { id: 10, x: 500, y: 360, name: 'Mid Center Left', riskTier: 'medium' },
  { id: 11, x: 640, y: 360, name: 'Mid Center Core', riskTier: 'high' },
  { id: 12, x: 780, y: 360, name: 'Mid Center Right', riskTier: 'medium' },

  // Upper tier platforms (y=280)
  { id: 13, x: 220, y: 230, name: 'High Left Outer', riskTier: 'low' },
  { id: 14, x: 360, y: 230, name: 'High Left Inner', riskTier: 'medium' },
  { id: 15, x: 920, y: 230, name: 'High Right Inner', riskTier: 'medium' },
